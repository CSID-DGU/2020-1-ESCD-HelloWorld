	...
	<div class="fixed">
		...
		out.print("<script>alert( ' " + a + "' );</script>");
				...
				<table border="1" align="center">
	 				...
	 				<tr>
	   					<td class="label" align="center" bgcolor=#50bcdf> 소속 단과 대학 </td>
	    				<td class="field"><%=college %></td>
	     			</tr>
	      
	         		<tr>
	          			<td class="label" align="center" bgcolor=#a0efff > 학과 </td>
	          			<td class="field"><%=major %></td> 
	           		</tr>
	           		
	           		<tr>
	             		<td class="label" align="center" bgcolor=#50bcdf> 학년 </td>
