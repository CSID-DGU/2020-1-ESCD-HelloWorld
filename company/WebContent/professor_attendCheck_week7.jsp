...
<style type = "text/css">
	...
	<form style="display:none"><br><br>
		...
		try{
			...
			String strSQL = "select student_college, student_major, student_year, student.student_id, student_name, attend_week7"
		...
		<center><font size="6" color="black"><b><%=c_name%> 7주차 출석부</b></font></center>
		...
		<button value ="week7_save" type="submit" name="submit" style="float: right;"  id="save">저장</button><Br>
